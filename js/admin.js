$(document).ready(function() {
    ...
    /* Envio del formulario con Ajax para eliminar novedad*/
    $('#del-nov-form form').submit(function(e) {
        e.preventDefault();
        var informacion=$('#del-nov-form form').serialize();
        var metodo=$('#del-nov-form form').attr('method');
        var peticion=$('#del-nov-form form').attr('action');
        $.ajax({
           type: metodo,
           url: peticion,
           data:informacion,
           beforeSend: function(){
               $("#res-form-del-nov").html('Eliminando producto <br><img src="assets/img/enviando.gif" class="center-all-contens">');
           },
           error: function() {
               $("#res-form-del-nov").html("Ha ocurrido un error en el sistema");
           },
           success: function (data) {
               $("#res-form-del-nov").html(data);
           }
       });
       return false;
   });
    /* Envio del formulario con Ajax para eliminar Nosotros*/
    $('#del-nos-form form').submit(function(e) {
        e.preventDefault();
        var informacion=$('#del-nos-form form').serialize();
        var metodo=$('#del-nos-form form').attr('method');
        var peticion=$('#del-nos-form form').attr('action');
        $.ajax({
           type: metodo,
           url: peticion,
           data:informacion,
           beforeSend: function(){
               $("#res-form-del-nos").html('Eliminando producto <br><img src="assets/img/enviando.gif" class="center-all-contens">');
           },
           error: function() {
               $("#res-form-del-nos").html("Ha ocurrido un error en el sistema");
           },
           success: function (data) {
               $("#res-form-del-nos").html(data);
           }
       });
       return false;
   });
    /* Envio del formulario con Ajax para eliminar Contactos*/
    $('#del-cont-form form').submit(function(e) {
        e.preventDefault();
        var informacion=$('#del-cont-form form').serialize();
        var metodo=$('#del-cont-form form').attr('method');
        var peticion=$('#del-cont-form form').attr('action');
        $.ajax({
           type: metodo,
           url: peticion,
           data:informacion,
           beforeSend: function(){
               $("#res-form-del-cont").html('Eliminando producto <br><img src="assets/img/enviando.gif" class="center-all-contens">');
           },
           error: function() {
               $("#res-form-del-cont").html("Ha ocurrido un error en el sistema");
           },
           success: function (data) {
               $("#res-form-del-cont").html(data);
           }
       });
       return false;
   });
    /* Envio del formulario con Ajax para eliminar libros*/
    $('#del-lib-form form').submit(function(e) {
        e.preventDefault();
        var informacion=$('#del-lib-form form').serialize();
        var metodo=$('#del-lib-form form').attr('method');
        var peticion=$('#del-lib-form form').attr('action');
        $.ajax({
           type: metodo,
           url: peticion,
           data:informacion,
           beforeSend: function(){
               $("#res-form-del-lib").html('Eliminando producto <br><img src="assets/img/enviando.gif" class="center-all-contens">');
           },
           error: function() {
               $("#res-form-del-lib").html("Ha ocurrido un error en el sistema");
           },
           success: function (data) {
               $("#res-form-del-lib").html(data);
           }
       });
       return false;
   });
