       ...
       <br>
        <div class="container">
            <div class="page-header">
              <h1>Libreria <small class="tittles-pages-logo">-Elim</small></h1>
            </div>
            <br><br>
            <div class="row">
                <div class="col-xs-12">
                            ...
                            if($totalproductos>0){
                                while($fila=mysqli_fetch_array($consulta)){
                                   ...
                                   <div class="col-xs-12 col-sm-6 col-md-4">
                                       <div class="thumbnail">
                                         <img src="assets/img-products/'.$fila['Imagen'].'" style="width:400px; height:400px;">
                                         <div class="caption" style="width:400px; height:160px;">
