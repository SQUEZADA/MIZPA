...
sleep(5);
$CodtProve= $_POST['Cod-prove'];
$cons=  ejecutarSQL::consultar("select * from proveedor where CodProveedor='$CodtProve'");
$totalprove = mysqli_num_rows($cons);

if($totalprove>0){
    if(consultasSQL::DeleteSQL('proveedor', "CodProveedor='".$CodtProve."'")){
