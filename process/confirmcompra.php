...
if($num>0){
  ...
  consultasSQL::InsertSQL("venta", "Fecha,UsuarioId, Codigo, Descuento, TotalPagar, Estado", "'".date('d-m-Y')."','".$_SESSION['nombreUser']."','".$nitC."','0','".$_SESSION['sumaTotal']."','".$StatusV."'");
  
  /*recuperando el número del pedido actual*/
  $verId=ejecutarSQL::consultar("select * from venta where Codigo='$nitC' order by NumPedido desc limit 1");
