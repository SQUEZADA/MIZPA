        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <?php
                  ...
                  $consulta= ejecutarSQL::consultar("SELECT * FROM `venta` as a INNER JOIN detalle as b ON b.NumPedido = a.NumPedido INNER JOIN producto as c ON c.CodigoProd = b.CodigoProd where a.estado='Pendiente'");
